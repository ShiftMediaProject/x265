...
This is a small list of steps in order to build x265 into a msvc DLL and lib file.
...
In order to build x265 using msvc you must first download and install YASM.
YASM is required to compile all x265 assembly files.
